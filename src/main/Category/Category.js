...
function Category(props) {
  ...
  const getCategoryTotalPage = () => {
    ...
    Axios.post("https://luanvan-server-1.herokuapp.com/get-category-total-page", data).then(
      (res) => {
  ...
  const getCategoryData = () => {
    ...
    Axios.post("https://luanvan-server-1.herokuapp.com/get-category-data?", data).then((res) => {
